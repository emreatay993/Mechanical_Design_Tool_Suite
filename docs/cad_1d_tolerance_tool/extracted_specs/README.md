...
| `2026-05-15_p17_visual_evidence_closeout.md` | P17 visual closeout evidence pack for current UI/report screenshots | Records live report snapshot proof, full-window native viewport capture blocker, and visual closeout status. |
| `2026-05-15_p18_live_runtime_packaged_smoke.md` | P18 live runtime and packaged smoke pass | Records source STEP/IGES/`.tolproj`/`.tolpack` smoke evidence, generated report/package artifact proof, packaged `Cad1DTolerance.exe` build/run smoke, and remaining native full-window viewport capture blocker. |
